...
public class ScenicInfoController {
    ...
    @GetMapping("/mapPage")
    @ApiOperation(value = "分页查询", notes = "分页查询")
    public R getScenicByMapPage(Page page, @RequestParam("scenic") String scenic) {
        return R.ok(iScenicInfoService.page(page, Wrappers.<ScenicInfo>lambdaQuery()
                .like(scenic !=null,ScenicInfo::getAddress,scenic)
                .or()
                .like(scenic!=null,ScenicInfo::getScenicName,scenic)));
    }
